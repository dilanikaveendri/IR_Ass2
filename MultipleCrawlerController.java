...
public class MultipleCrawlerController {
    public static void main(String[] args) throws Exception {
        ...
        htmlController.addSeed("https://www.bbc.com/news/coronavirus");
        imageController.addSeed("https://www.bbc.com/news/coronavirus");

        CrawlerStatistic stats = new CrawlerStatistic();
