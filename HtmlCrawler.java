...
public class HtmlCrawler extends WebCrawler {
    ...
    private CrawlerStatistic stats;

    public HtmlCrawler(CrawlerStatistic stats) {
        this.stats = stats;
    }
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        return !EXCLUSIONS.matcher(urlString).matches()
                && urlString.startsWith("https://www.bbc.com/news/coronavirus");
    }
    ...
    public void visit(Page page) {
        ...
        if (page.getParseData() instanceof HtmlParseData) {
            ...
            try {
                ...
                pw.flush();
                //myWriter.write("<DOC> <DOCNO> " +counter + " </DOCNO> " + title + " </DOC>\n");
            } catch (IOException e) {
                e.printStackTrace();
            }
